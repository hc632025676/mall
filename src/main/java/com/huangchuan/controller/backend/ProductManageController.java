package com.huangchuan.controller.backend;
...
import com.huangchuan.service.IFileService;
...
//        }
        if(iUserService.checkAdminRole(user).isSuccess()){
            ...
            response.addHeader("Access-Control-Allow-Headers","X-File-Name");//文档要求返回的，与前端约定
            return resultMap;
        }else{
            resultMap.put("success",false);
